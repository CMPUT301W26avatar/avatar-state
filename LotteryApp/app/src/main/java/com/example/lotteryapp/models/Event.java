...
public class Event {
    ...
    public int getInvitationCapacity() {return invitationCapacity;}

    public void setInvitationCapacity(int invitationCapacity) {this.invitationCapacity = invitationCapacity;}
