...
public class UserProfileActivity extends AppCompatActivity {
    ...
    private String uuid;
    public static UserStorage TEST_USER_STORAGE = null;
    public static String TEST_UUID = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userStorage = (TEST_USER_STORAGE != null) ? TEST_USER_STORAGE : new UserStorage(db.getDb());
